...
__all__ = [
    ...
    "plot_press_dist", "plot_volume_dist", "plot_density", "plot_domain_pars",
...
def plot_domain_pars(f, fn_png="domain_pars.png", **kwargs):
    """Make a plot of the domain parameters as function of time
       **Arguments:**
       f
            An h5.File instance containing the trajectory data.
       **Optional arguments:**
    ...
    if nvec == 3:
        ...
        raise ValueError("Can not plot domain parameters if the system is not periodic.")
